...
//        console.log("bonjour");
    ...
    if(jQuery('#block-languageswitcher li').is('.nl.is-active')){
        ...
        jQuery('main #projets .view-projets .row-1 h2::after').css('background-image','none');
        jQuery('main #projets .view-projets .row-1 h2::after').css('width','0');
        jQuery('main #projets .view-projets .row-1 h2::after').css('height','0');
        jQuery('main #projets .view-projets .row-2 h2::after').css('background-image','none');
        jQuery('main #projets .view-projets .row-3 h2::after').css('background-image','none');
