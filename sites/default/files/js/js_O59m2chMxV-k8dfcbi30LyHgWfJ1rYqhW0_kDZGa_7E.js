...
jQuery(window).scroll(function(e){
    if(jQuery(window).width() > 840){
        ...
        if (jQuery(this).scrollTop() > 194) {

            jQuery('nav').addClass('navScroll');
            jQuery('nav > div').addClass('col-xs-12 col-sm-12 col-md-12 col-lg-12');
            jQuery('main').css('position', 'relative');
            jQuery('main').css('top', '15px');
        
        }else{
            jQuery('nav').removeClass('navScroll');
            jQuery('nav > div').removeClass('col-xs-12 col-sm-12 col-md-12 col-lg-12');
            jQuery('nav > div').addClass('col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1');
        }
    }
//    else{
//        jQuery('nav').addClass('navBar');
//    }
