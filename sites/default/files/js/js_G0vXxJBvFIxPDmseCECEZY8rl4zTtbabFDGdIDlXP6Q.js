...
//        jQuery('#projets .view-projets .row-1 h2::after').css('background-image','none');
        jQuery('#projets .view-projets .row-1 h2::after').css('width','120px');
        jQuery('#projets .view-projets .row-1 h2::after').css('height','120px');
//        jQuery('#projets .view-projets .row-2 h2::after').css('background-image','none');
//        jQuery('#projets .view-projets .row-3 h2::after').css('background-image','none');
