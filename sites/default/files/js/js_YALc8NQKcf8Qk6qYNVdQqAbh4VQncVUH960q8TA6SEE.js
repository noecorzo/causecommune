...
//cause solidaire
    ...
    //cause educative
    jQuery('.row-2 .field--name-field-bouton button').mouseenter(function(e){
        console.log("hello");
    ...
    jQuery('.row-2 .field--name-field-bouton button').mouseleave(function(e){
        console.log("bonjour");
    ...
    //cause ecosociale
    jQuery('.row-3 .field--name-field-bouton button').mouseenter(function(e){
    ...
    jQuery('.row-3 .field--name-field-bouton button').mouseleave(function(e){
